...
class ExamPageWidget extends StatefulWidget {
  const ExamPageWidget({super.key});
...
class _ExamPageWidgetState extends State<ExamPageWidget> {
  ...
  void initState() {
    ...
    _model.inputExamTextController ??= TextEditingController();
    _model.inputExamFocusNode ??= FocusNode();
    _model.inputExamFocusNode!.addListener(() => safeSetState(() {}));
  }
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller: _model.inputExamTextController,
                                    focusNode: _model.inputExamFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.inputExamFocusNode
                                                  ?.hasFocus ??
                                              false)
                                    ...
                                    validator: _model
                                        .inputExamTextControllerValidator
                                        .asValidator(context),
                                  ),
                                  Text(
                                    'Result',
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        _model.answer = double.tryParse(
                            _model.inputExamTextController.text);
                        safeSetState(() {});
                      },
                      text: 'Submit',
